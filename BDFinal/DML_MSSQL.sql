...
-- (Los dejo comentados; tú los insertarás hasheados)
-- =============================================
-- INSERT INTO PA_USUARIOS
--     (USUARIO_ID, CORREO_ELECTRONICO, NOMBRE_DE_USUARIO, NOMBRE, APELLIDOS, ACTIVO, PASSWORD_HASH, SUPERUSUARIO)
-- VALUES
...
-- (Requiere que existan USUARIO_ID 1..6 en PA_USUARIOS)
-- =============================================
...
-- Perú
('Banco de Crédito del Perú', 'TXT,XLS', 'BCPLPEPL', 1),
('Interbank', 'TXT,CSV', 'BINPPEPL', 1),
('BBVA Perú', 'XLS,CSV', 'BCONPEPL', 1),
('Scotiabank Perú', 'TXT,XLS', 'BSUDPEPL', 1),
('Banco Pichincha', 'CSV,XLS', 'PINPPEPL', 1),
-- México
('BBVA México', 'XLS,CSV', 'BCMRMXMM', 2),
('Banco Santander México', 'TXT,CSV', 'BMSXMXMM', 2),
('Banorte', 'TXT,XLS', 'MENOMXMT', 2),
('HSBC México', 'CSV,XLS', 'BIMEMXMM', 2),
('Scotiabank México', 'TXT,CSV', 'MBCOMXMM', 2),
-- Colombia
('Bancolombia', 'TXT,CSV', 'COLOCOBM', 3),
('Banco de Bogotá', 'XLS,CSV', 'BBOPCOBM', 3),
('Davivienda', 'TXT,XLS', 'CAFECOBM', 3),
('BBVA Colombia', 'CSV,XLS', 'BBVACOBM', 3),
('Banco de Occidente', 'TXT,CSV', 'OCCICOBM', 3);
GO
...
-- =============================================
-- 9. INSERCIÓN DE FACTURAS (fechas actualizadas)
-- =============================================
...
('F001-00001234', '2025-11-15 10:30:00', '2025-11-16 14:20:00', '2025-12-15 23:59:59', 'Pendiente', 11800.00, 1800.00, 11800.00, 'Régimen General', 18.00, 0.00, 1, 1),
('F001-00001235', '2025-11-20 11:15:00', '2025-11-21 09:45:00', '2025-12-20 23:59:59', 'Pendiente', 23600.00, 3600.00, 23600.00, 'Régimen General', 18.00, 0.00, 1, 2),
('F001-00001236', '2025-12-01 14:00:00', '2025-12-02 10:30:00', '2025-12-31 23:59:59', 'Pendiente', 8260.00, 1260.00, 8260.00, 'Régimen General', 18.00, 0.00, 1, 3),
('F001-00001237', '2025-12-05 09:20:00', '2025-12-06 15:10:00', '2025-12-20 23:59:59', 'Pendiente', 17700.00, 2700.00, 17700.00, 'Régimen General', 18.00, 0.00, 1, 4),
-- Perú - Facturas en USD
('F001-00001238', '2025-11-18 13:45:00', '2025-11-19 11:20:00', '2025-12-18 23:59:59', 'Pendiente', 8850.00, 1350.00, 8850.00, 'Régimen General', 18.00, 0.00, 4, 1),
...
('A-00002001', '2025-11-12 12:30:00', '2025-11-13 16:45:00', '2025-12-12 23:59:59', 'Pendiente', 46400.00, 7400.00, 46400.00, 'Régimen General', 16.00, 0.00, 2, 7),
('A-00002002', '2025-11-22 15:20:00', '2025-11-23 10:15:00', '2025-12-22 23:59:59', 'Pendiente', 69600.00, 11100.00, 69600.00, 'Régimen General', 16.00, 0.00, 2, 8),
('A-00002003', '2025-12-03 11:00:00', '2025-12-04 14:30:00', '2026-01-02 23:59:59', 'Pendiente', 34800.00, 5550.00, 34800.00, 'Régimen General', 16.00, 0.00, 2, 9),
-- México - Facturas en USD
('A-00002004', '2025-11-28 09:45:00', '2025-11-29 13:20:00', '2025-12-28 23:59:59', 'Pendiente', 11600.00, 1850.00, 11600.00, 'Régimen General', 16.00, 0.00, 4, 7),
-- Colombia - Facturas en COP
('FV-000030001', '2025-11-10 10:15:00', '2025-11-11 15:30:00', '2025-12-10 23:59:59', 'Pendiente', 11400000.00, 1800000.00, 11400000.00, 'Régimen Común', 19.00, 0.00, 3, 12),
('FV-000030002', '2025-11-17 14:20:00', '2025-11-18 09:40:00', '2026-01-16 23:59:59', 'Pendiente', 28500000.00, 4500000.00, 28500000.00, 'Régimen Común', 19.00, 0.00, 3, 13),
('FV-000030003', '2025-12-02 11:30:00', '2025-12-03 16:15:00', '2026-01-01 23:59:59', 'Pendiente', 17100000.00, 2700000.00, 17100000.00, 'Régimen Común', 19.00, 0.00, 3, 14),
-- Colombia - Facturas en USD
('FV-000030004', '2025-11-24 13:00:00', '2025-11-25 10:45:00', '2025-12-24 23:59:59', 'Pendiente', 9500.00, 1500.00, 9500.00, 'Régimen Común', 19.00, 0.00, 4, 12),
('FV-000030005', '2025-12-08 15:45:00', '2025-12-09 11:20:00', '2025-12-23 23:59:59', 'Pendiente', 7600.00, 1200.00, 7600.00, 'Régimen Común', 19.00, 0.00, 4, 15);
GO
...
-- (Requiere USUARIO_ID válidos)
-- =============================================
INSERT INTO PA_PROPUESTAS_DE_PAGO
    (FECHA_HORA_CREACION, ESTADO, ENTIDAD_BANCARIA_ID,
     FECHA_HORA_MODIFICACION, USUARIO_MODIFICACION, USUARIO_CREACION)
VALUES
-- Propuesta 1 - Perú - BCP
('2024-10-10 09:00:00', 'APROBADA', 1,  '2024-10-10 10:30:00', 1, 2),
-- Propuesta 2 - Perú - Interbank
('2024-10-12 10:15:00', 'PENDIENTE', 2, '2024-10-12 10:15:00', 3, 3),
-- Propuesta 3 - México - BBVA México
('2024-10-14 11:30:00', 'APROBADA', 6, '2024-10-14 14:20:00', 1, 4),
-- Propuesta 4 - Colombia - Bancolombia
('2024-10-15 13:45:00', 'PENDIENTE', 11,'2024-10-15 13:45:00', 6, 6),
-- Propuesta 5 - Perú - BBVA Perú
('2024-10-18 08:30:00', 'APROBADA', 3, '2024-10-18 09:45:00', 1, 2);
GO

-- =============================================
-- 12. INSERCIÓN DE DETALLES DE PROPUESTAS
-- =============================================
INSERT INTO PA_DETALLES_PROPUESTA
    (MONTO_PAGO, FORMA_PAGO, PROPUESTA_DE_PAGO_ID,
     FACTURA_ID, CUENTA_ACREEDOR_ID, CUENTA_PROPIA_ID)
VALUES
