...
-- =============================================
-- 1. INSERCIÓN DE PAÍSES (Solo Perú, México, Colombia)
-- =============================================
...
-- =============================================
-- 2. INSERCIÓN DE MONEDAS (PEN, MXN, COP, USD, EUR)
-- =============================================
...
-- =============================================
-- 3. INSERCIÓN DE ENTIDADES BANCARIAS
-- =============================================
...
-- =============================================
-- 4. INSERCIÓN DE ACREEDORES
-- =============================================
INSERT INTO PA_ACREEDORES
    (RAZON_SOCIAL, RUC, DIRECCION_FISCAL, CONDICION, PLAZO_DE_PAGO, ACTIVO, PAIS_ID)
VALUES
-- Perú
...
-- México
('Distribuidora Nacional SA de CV', 'DNM120101A01', 'Av. Reforma 1234, Ciudad de México', 'Activo', 30, 'S', 2),
('Industrias del Norte SA de CV', 'IDN130202D01', 'Blvd. Insurgentes 567, Monterrey', 'Activo', 45, 'S', 2),
('Servicios Empresariales MX SA de CV', 'SEM140303G01', 'Av. Universidad 890, Guadalajara', 'Activo', 30, 'S', 2),
('Tecnología Avanzada SA de CV', 'TAV150404J01', 'Calle Reforma 234, Querétaro', 'Activo', 15, 'S', 2),
('Comercializadora del Bajío SA de CV', 'CDB160505M01', 'Av. Central 567, León', 'Activo', 60, 'S', 2),
-- Colombia
...
-- =============================================
-- 5. INSERCIÓN DE CUENTAS PROPIAS
-- =============================================
INSERT INTO PA_CUENTAS_PROPIAS
    (SALDO_DISPONIBLE, TIPO_CUENTA, NUMERO_CUENTA, CCI, ACTIVO, ENTIDAD_BANCARIA_ID, MONEDA_ID)
VALUES
-- Perú
...
-- =============================================
-- INSERTS DE RELLENO DE DATOS
-- =============================================
---- =============================================
---- 7. INSERCIÓN DE CUENTAS DE ACREEDORES
---- =============================================
--INSERT INTO PA_CUENTAS_ACREEDOR
--    (TIPO_CUENTA, NUMERO_CUENTA, CCI, ACTIVO, ACREEDOR_ID, ENTIDAD_BANCARIA_ID, MONEDA_ID)
--VALUES
...
---- =============================================
---- 8. INSERCIÓN DE FACTURAS (fechas actualizadas)
---- =============================================
--INSERT INTO PA_FACTURAS
--    (NUMERO_FACTURA, FECHA_EMISION, FECHA_RECEPCION, FECHA_LIMITE_PAGO,
--     ESTADO, MONTO_TOTAL, MONTO_IGV, MONTO_RESTANTE,
--     REGIMEN_FISCAL, TASA_IVA, OTROS_TRIBUTOS, MONEDA_ID, ACREEDOR_ID)
--VALUES
---- Perú - Facturas en PEN
--('F001-00001234', '2025-11-24 10:30:00', '2025-11-26 14:20:00', '2025-12-15 23:59:59', 'Pendiente', 11800.00, 1800.00, 11800.00, 'Régimen --General', 18.00, 0.00, 1, 1),
--('F001-00001235', '2025-11-25 11:15:00', '2025-11-26 09:45:00', '2025-12-20 23:59:59', 'Pendiente', 23600.00, 3600.00, 23600.00, 'Régimen --General', 18.00, 0.00, 1, 2),
--('F001-00001236', '2025-11-25 14:00:00', '2025-11-26 10:30:00', '2025-12-31 23:59:59', 'Pendiente', 8260.00, 1260.00, 8260.00, 'Régimen --General', 18.00, 0.00, 1, 3),
--('F001-00001237', '2025-11-25 09:20:00', '2025-11-26 15:10:00', '2025-12-20 23:59:59', 'Pendiente', 17700.00, 2700.00, 17700.00, 'Régimen --General', 18.00, 0.00, 1, 4),
---- Perú - Facturas en USD
--('F001-00001238', '2025-11-24 13:45:00', '2025-11-26 11:20:00', '2025-12-18 23:59:59', 'Pendiente', 8850.00, 1350.00, 8850.00, 'Régimen --General', 18.00, 0.00, 4, 1),
--('F001-00001239', '2025-11-25 10:00:00', '2025-11-26 08:30:00', '2026-01-09 23:59:59', 'Pendiente', 14160.00, 2160.00, 14160.00, 'Régimen --General', 18.00, 0.00, 4, 2),
---- México - Facturas en MXN
--('A-00002001', '2025-11-24 12:30:00', '2025-11-26 16:45:00', '2025-12-12 23:59:59', 'Pendiente', 46400.00, 7400.00, 46400.00, 'Régimen --General', 16.00, 0.00, 2, 7),
--('A-00002002', '2025-11-25 15:20:00', '2025-11-26 10:15:00', '2025-12-22 23:59:59', 'Pendiente', 69600.00, 11100.00, 69600.00, 'Régimen --General', 16.00, 0.00, 2, 8),
--('A-00002003', '2025-11-25 11:00:00', '2025-11-26 14:30:00', '2026-01-02 23:59:59', 'Pendiente', 34800.00, 5550.00, 34800.00, 'Régimen --General', 16.00, 0.00, 2, 9),
---- México - Facturas en USD
--('A-00002004', '2025-11-25 09:45:00', '2025-11-26 13:20:00', '2025-12-28 23:59:59', 'Pendiente', 11600.00, 1850.00, 11600.00, 'Régimen --General', 16.00, 0.00, 4, 7),
---- Colombia - Facturas en COP
--('FV-000030001', '2025-11-25 10:15:00', '2025-11-26 15:30:00', '2025-12-10 23:59:59', 'Pendiente', 11400000.00, 1800000.00, 11400000.00, --'Régimen Común', 19.00, 0.00, 3, 12),
--('FV-000030002', '2025-11-24 14:20:00', '2025-11-26 09:40:00', '2026-01-16 23:59:59', 'Pendiente', 28500000.00, 4500000.00, 28500000.00, --'Régimen Común', 19.00, 0.00, 3, 13),
--('FV-000030003', '2025-11-25 11:30:00', '2025-11-26 16:15:00', '2026-01-01 23:59:59', 'Pendiente', 17100000.00, 2700000.00, 17100000.00, --'Régimen Común', 19.00, 0.00, 3, 14),
---- Colombia - Facturas en USD
--('FV-000030004', '2025-11-24 13:00:00', '2025-11-26 10:45:00', '2025-12-24 23:59:59', 'Pendiente', 9500.00, 1500.00, 9500.00, 'Régimen --Común', 19.00, 0.00, 4, 12),
--('FV-000030005', '2025-11-25 15:45:00', '2025-11-26 11:20:00', '2025-12-23 23:59:59', 'Pendiente', 7600.00, 1200.00, 7600.00, 'Régimen --Común', 19.00, 0.00, 4, 15);
--GO
...
---- =============================================
---- 9. INSERCIÓN DE DETALLES DE FACTURAS
---- =============================================
--INSERT INTO PA_DETALLES_FACTURA
--    (SUBTOTAL, DESCRIPCION, FACTURA_ID)
--VALUES
...
---- =============================================
---- 10. INSERCIÓN EN TABLA DE REPORTES - FACTURAS PENDIENTES
---- =============================================
--INSERT INTO PA_REPORTES_FACTURAS_PENDIENTES 
--    (FACTURA_ID, ACREEDOR_ID, PAIS_ID, MONEDA_ID, NUMERO_FACTURA,
--     RAZON_SOCIAL, NOMBRE_PAIS, CODIGO_MONEDA,
--     FECHA_LIMITE_PAGO, DIAS_VENCIMIENTO, RANGO_VENCIMIENTO, MONTO_RESTANTE)
--VALUES
---- Facturas Perú
--(1, 1, 1, 1, 'F001-00001234', 'Corporación Textil SAC', 'Perú', 'PEN', '2024-10-15 23:59:59', -11, 'VENCIDO', 11800.00),
--(2, 2, 1, 1, 'F001-00001235', 'Inversiones Mineras del Sur SA', 'Perú', 'PEN', '2024-10-20 23:59:59', -6, 'VENCIDO', 8600.00),
--(3, 3, 1, 1, 'F001-00001236', 'Servicios Logísticos Unidos EIRL', 'Perú', 'PEN', '2024-10-31 23:59:59', 5, '0-15', 8260.00),
--(4, 4, 1, 1, 'F001-00001237', 'Tecnología y Sistemas SAC', 'Perú', 'PEN', '2024-10-20 23:59:59', -6, 'VENCIDO', 0.00),
--(5, 1, 1, 4, 'F001-00001238', 'Corporación Textil SAC', 'Perú', 'USD', '2024-10-18 23:59:59', -8, 'VENCIDO', 0.00),
--(6, 2, 1, 4, 'F001-00001239', 'Inversiones Mineras del Sur SA', 'Perú', 'USD', '2024-11-09 23:59:59', 14, '0-15', 0.00),
---- Facturas México
--(7, 7, 2, 2, 'A-00002001', 'Distribuidora Nacional SA de CV', 'México', 'MXN', '2024-10-12 23:59:59', -14, 'VENCIDO', 0.00),
--(8, 8, 2, 2, 'A-00002002', 'Industrias del Norte SA de CV', 'México', 'MXN', '2024-10-22 23:59:59', -4, 'VENCIDO', 69600.00),
--(9, 9, 2, 2, 'A-00002003', 'Servicios Empresariales MX SA de CV', 'México', 'MXN', '2024-11-02 23:59:59', 7, '0-15', 34800.00),
--(10, 7, 2, 4, 'A-00002004', 'Distribuidora Nacional SA de CV', 'México', 'USD', '2024-10-28 23:59:59', 2, '0-15', 0.00),
---- Facturas Colombia
--(11, 12, 3, 3, 'FV-000030001', 'Comercializadora Andina SAS', 'Colombia', 'COP', '2024-10-10 23:59:59', -16, 'VENCIDO', 0.00),
--(12, 13, 3, 3, 'FV-000030002', 'Productos Industriales Colombia SA', 'Colombia', 'COP', '2024-11-16 23:59:59', 21, '16-30', 28500000.00),
--(13, 14, 3, 3, 'FV-000030003', 'Distribuidora Cafetera SAS', 'Colombia', 'COP', '2024-11-01 23:59:59', 6, '0-15', 17100000.00),
--(14, 12, 3, 4, 'FV-000030004', 'Comercializadora Andina SAS', 'Colombia', 'USD', '2024-10-24 23:59:59', -2, 'VENCIDO', 0.00),
--(15, 15, 3, 4, 'FV-000030005', 'Tecnología Digital Colombia SAS', 'Colombia', 'USD', '2024-10-23 23:59:59', -3, 'VENCIDO', 7600.00);
--GO