...
-- Schema softpacbd
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `softpacbd` ;

-- -----------------------------------------------------
-- Schema softpacbd
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `softpacbd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `softpacbd` ;

-- -----------------------------------------------------
-- Table `softpacbd`.`PA_ACREEDORES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_ACREEDORES` ;
...
CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_ACREEDORES` (
  ...
  `CONDICION` VARCHAR(100) NULL DEFAULT NULL,
  `PLAZO_DE_PAGO` INT NOT NULL,
  `ACTIVO` CHAR(1) NOT NULL DEFAULT 'S',
  `PAIS_ID` INT UNSIGNED NOT NULL,
  `FECHA_ELIMINACION` DATETIME NULL DEFAULT NULL,
  `USUARIO_ELIMINACION` INT UNSIGNED NULL DEFAULT NULL,
...
CREATE UNIQUE INDEX `UQ_PA_ACREEDORES_RUC` ON `softpacbd`.`PA_ACREEDORES` (`RUC` ASC) VISIBLE;

CREATE INDEX `IDX_PA_ACREEDORES_PAIS_ID` ON `softpacbd`.`PA_ACREEDORES` (`PAIS_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_ACREEDORES_PA_USUARIOS1_idx` ON `softpacbd`.`PA_ACREEDORES` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_CUENTAS_ACREEDOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_CUENTAS_ACREEDOR` ;
...
CREATE UNIQUE INDEX `UQ_PA_CUENTAS_ACREEDOR_NUMERO_CUENTA` ON `softpacbd`.`PA_CUENTAS_ACREEDOR` (`NUMERO_CUENTA` ASC) VISIBLE;

CREATE INDEX `IDX_PA_CUENTAS_ACREEDOR_ACREEDOR_ID` ON `softpacbd`.`PA_CUENTAS_ACREEDOR` (`ACREEDOR_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_ACREEDOR_PA_ENTIDADES_BANCARIAS1_idx` ON `softpacbd`.`PA_CUENTAS_ACREEDOR` (`ENTIDAD_BANCARIA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_ACREEDOR_PA_MONEDAS1_idx` ON `softpacbd`.`PA_CUENTAS_ACREEDOR` (`MONEDA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_ACREEDOR_PA_USUARIOS1_idx` ON `softpacbd`.`PA_CUENTAS_ACREEDOR` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_CUENTAS_PROPIAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_CUENTAS_PROPIAS` ;
...
CREATE UNIQUE INDEX `UQ_PA_CUENTAS_PROPIAS_NUMERO_CUENTA` ON `softpacbd`.`PA_CUENTAS_PROPIAS` (`NUMERO_CUENTA` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_PROPIAS_PA_ENTIDADES_BANCARIAS1_idx` ON `softpacbd`.`PA_CUENTAS_PROPIAS` (`ENTIDAD_BANCARIA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_PROPIAS_PA_MONEDAS1_idx` ON `softpacbd`.`PA_CUENTAS_PROPIAS` (`MONEDA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_CUENTAS_PROPIAS_PA_USUARIOS1_idx` ON `softpacbd`.`PA_CUENTAS_PROPIAS` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_DETALLES_FACTURA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_DETALLES_FACTURA` ;
...
CREATE INDEX `IDX_PA_DETALLES_FACTURA_FACTURA_ID` ON `softpacbd`.`PA_DETALLES_FACTURA` (`FACTURA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_DETALLES_FACTURA_PA_USUARIOS1_idx` ON `softpacbd`.`PA_DETALLES_FACTURA` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_DETALLES_PROPUESTA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_DETALLES_PROPUESTA` ;
...
CREATE INDEX `IDX_PA_DETALLES_PROPUESTA_PROPUESTA_DE_PAGO_ID` ON `softpacbd`.`PA_DETALLES_PROPUESTA` (`PROPUESTA_DE_PAGO_ID` ASC) VISIBLE;

CREATE INDEX `IDX_PA_DETALLES_PROPUESTA_FACTURA_ID` ON `softpacbd`.`PA_DETALLES_PROPUESTA` (`FACTURA_ID` ASC) VISIBLE;

CREATE INDEX `IDX_PA_DETALLES_PROPUESTA_CUENTA_ACREEDOR_ID` ON `softpacbd`.`PA_DETALLES_PROPUESTA` (`CUENTA_ACREEDOR_ID` ASC) VISIBLE;

CREATE INDEX `IDX_PA_DETALLES_PROPUESTA_CUENTA_PROPIA_ID` ON `softpacbd`.`PA_DETALLES_PROPUESTA` (`CUENTA_PROPIA_ID` ASC) INVISIBLE;

CREATE INDEX `fk_PA_DETALLES_PROPUESTA_PA_USUARIOS1_idx` ON `softpacbd`.`PA_DETALLES_PROPUESTA` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_ENTIDADES_BANCARIAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_ENTIDADES_BANCARIAS` ;
...
CREATE INDEX `IDX_PA_ENTIDADES_BANCARIAS_PAIS_ID` ON `softpacbd`.`PA_ENTIDADES_BANCARIAS` (`PAIS_ID` ASC) INVISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_ESTADO_CUENTAS_PROPIAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_ESTADO_CUENTAS_PROPIAS` ;

CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_ESTADO_CUENTAS_PROPIAS` (
  `CUENTA_PROPIA_ID` INT UNSIGNED NOT NULL,
  `FECHA_MODIFICACION` DATETIME NOT NULL,
  `SALDO_MODIFICACION` DECIMAL(15,2) NOT NULL,
  `USUARIO_MODIFICACION` INT UNSIGNED NOT NULL,
  `SALDO_RESULTANTE` DECIMAL(15,2) NOT NULL,
  CONSTRAINT `fk_PA_KARDEX_CUENTAS_PROPIAS_PA_CUENTAS_PROPIAS1`
    FOREIGN KEY (`CUENTA_PROPIA_ID`)
    REFERENCES `softpacbd`.`PA_CUENTAS_PROPIAS` (`CUENTA_PROPIA_ID`),
  CONSTRAINT `fk_PA_KARDEX_CUENTAS_PROPIAS_PA_USUARIOS1`
...
CREATE INDEX `fk_PA_KARDEX_CUENTAS_PROPIAS_PA_USUARIOS1_idx` ON `softpacbd`.`PA_ESTADO_CUENTAS_PROPIAS` (`USUARIO_MODIFICACION` ASC) VISIBLE;

CREATE INDEX `fk_PA_KARDEX_CUENTAS_PROPIAS_PA_CUENTAS_PROPIAS1_idx` ON `softpacbd`.`PA_ESTADO_CUENTAS_PROPIAS` (`CUENTA_PROPIA_ID` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_FACTURAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_FACTURAS` ;
...
CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_FACTURAS` (
  ...
  `TASA_IVA` DECIMAL(15,2) NULL DEFAULT NULL,
  `OTROS_TRIBUTOS` DECIMAL(15,2) NULL DEFAULT NULL,
  `MONEDA_ID` INT UNSIGNED NOT NULL,
  `ACREEDOR_ID` INT UNSIGNED NOT NULL,
  `FECHA_ELIMINACION` DATETIME NULL DEFAULT NULL,
  `USUARIO_ELIMINACION` INT UNSIGNED NULL DEFAULT NULL,
...
CREATE UNIQUE INDEX `UQ_PA_FACTURAS_NUMERO_FACTURA` ON `softpacbd`.`PA_FACTURAS` (`NUMERO_FACTURA` ASC) VISIBLE;

CREATE INDEX `IDX_PA_FACTURAS_ACREEDOR_ID` ON `softpacbd`.`PA_FACTURAS` (`ACREEDOR_ID` ASC) VISIBLE;

CREATE INDEX `IDX_PA_FACTURAS_MONEDA_ID` ON `softpacbd`.`PA_FACTURAS` (`MONEDA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_FACTURAS_PA_USUARIOS1_idx` ON `softpacbd`.`PA_FACTURAS` (`USUARIO_ELIMINACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_MONEDAS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_MONEDAS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_PAISES` ;
...
CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_PAISES` (
  ...
  `CODIGO_TELEFONICO` CHAR(3) NULL DEFAULT NULL,
  PRIMARY KEY (`PAIS_ID`))
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
...
CREATE UNIQUE INDEX `UQ_PA_PAISES_NOMBRE` ON `softpacbd`.`PA_PAISES` (`NOMBRE` ASC) VISIBLE;

CREATE UNIQUE INDEX `UQ_PA_PAISES_CODIGO_ISO` ON `softpacbd`.`PA_PAISES` (`CODIGO_ISO` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_PROPUESTAS_DE_PAGO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_PROPUESTAS_DE_PAGO` ;
...
CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_PROPUESTAS_DE_PAGO` (
  ...
  `USUARIO_MODIFICACION` INT UNSIGNED NOT NULL,
  `USUARIO_CREACION` INT UNSIGNED NOT NULL,
  `FECHA_ELIMINACION` DATETIME NULL DEFAULT NULL,
  `USUARIO_ELIMINACION` INT UNSIGNED NULL DEFAULT NULL,
...
CREATE INDEX `IDX_PA_PROPUESTAS_DE_PAGO_ENTIDAD_BANCARIA_ID` ON `softpacbd`.`PA_PROPUESTAS_DE_PAGO` (`ENTIDAD_BANCARIA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_PROPUESTAS_DE_PAGO_PA_USUARIOS1_idx` ON `softpacbd`.`PA_PROPUESTAS_DE_PAGO` (`USUARIO_ELIMINACION` ASC) VISIBLE;

CREATE INDEX `fk_PA_PROPUESTAS_DE_PAGO_PA_USUARIOS1_idx1` ON `softpacbd`.`PA_PROPUESTAS_DE_PAGO` (`USUARIO_MODIFICACION` ASC) VISIBLE;

CREATE INDEX `fk_PA_PROPUESTAS_DE_PAGO_PA_USUARIOS1_idx2` ON `softpacbd`.`PA_PROPUESTAS_DE_PAGO` (`USUARIO_CREACION` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES` ;
...
CREATE INDEX `fk_PA_REPORTES_FACTURAS_PENDIENTES_PA_FACTURAS1_idx` ON `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES` (`FACTURA_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_REPORTES_FACTURAS_PENDIENTES_PA_ACREEDORES1_idx` ON `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES` (`ACREEDOR_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_REPORTES_FACTURAS_PENDIENTES_PA_PAISES1_idx` ON `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES` (`PAIS_ID` ASC) VISIBLE;

CREATE INDEX `fk_PA_REPORTES_FACTURAS_PENDIENTES_PA_MONEDAS1_idx` ON `softpacbd`.`PA_REPORTES_FACTURAS_PENDIENTES` (`MONEDA_ID` ASC) VISIBLE;

-- -----------------------------------------------------
-- Table `softpacbd`.`PA_USUARIOS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_USUARIOS` ;
...
CREATE UNIQUE INDEX `uq_nombre_de_usuario` ON `softpacbd`.`PA_USUARIOS` (`NOMBRE_DE_USUARIO` ASC) VISIBLE;

CREATE INDEX `fk_PA_USUARIOS_PA_USUARIOS1_idx` ON `softpacbd`.`PA_USUARIOS` (`USUARIO_ELIMINACION` ASC) VISIBLE;

-- -----------------------------------------------------
-- Table `softpacbd`.`PA_USUARIO_PAIS_ACCESO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `softpacbd`.`PA_USUARIO_PAIS_ACCESO` ;
...
CREATE TABLE IF NOT EXISTS `softpacbd`.`PA_USUARIO_PAIS_ACCESO` (
  ...
  CONSTRAINT `fk_PA_USUARIO_PAIS_ACCESO_PA_PAISES1`
    FOREIGN KEY (`PAIS_ID`)
    REFERENCES `softpacbd`.`PA_PAISES` (`PAIS_ID`),
...
CREATE INDEX `fk_PA_USUARIO_PAIS_ACCESO_PA_PAISES1_idx` ON `softpacbd`.`PA_USUARIO_PAIS_ACCESO` (`PAIS_ID` ASC) INVISIBLE;

CREATE INDEX `fk_PA_USUARIO_PAIS_ACCESO_PA_USUARIOS1_idx` ON `softpacbd`.`PA_USUARIO_PAIS_ACCESO` (`USUARIO_ID` ASC) VISIBLE;
...
USE `softpacbd`;
DROP procedure IF EXISTS `softpacbd`.`pa_sp_reporte_facturas_pendientes`;

DELIMITER $$
USE `softpacbd`$$
CREATE DEFINER=`admin`@`%` PROCEDURE `pa_sp_reporte_facturas_pendientes`(
    IN p_acreedor_id INT,   -- NULL = sin filtro
    IN p_pais_id     INT,   -- NULL = sin filtro
    IN p_moneda_id   INT    -- NULL = sin filtro
)
BEGIN
  ...
  SELECT
      ...
      src.NOMBRE_PAIS,
      src.CODIGO_MONEDA,
      src.FECHA_LIMITE_PAGO,
      src.DIAS_VENCIMIENTO,
      src.RANGO_VENCIMIENTO,
      src.MONTO_RESTANTE
  FROM (
      SELECT
          f.FACTURA_ID,
          ...
          f.FECHA_LIMITE_PAGO,
          DATEDIFF(f.FECHA_LIMITE_PAGO, CURDATE()) AS DIAS_VENCIMIENTO,
          CASE
            WHEN DATEDIFF(f.FECHA_LIMITE_PAGO, CURDATE()) BETWEEN 0 AND 30  THEN '0-30'
            WHEN DATEDIFF(f.FECHA_LIMITE_PAGO, CURDATE()) BETWEEN 31 AND 60 THEN '31-60'
            WHEN DATEDIFF(f.FECHA_LIMITE_PAGO, CURDATE()) BETWEEN 61 AND 90 THEN '61-90'
            ELSE '+90'
      ...
      WHERE f.ESTADO = 'PENDIENTE'
		AND DATEDIFF(f.FECHA_LIMITE_PAGO, CURDATE()) >= 0
  ...
  ON DUPLICATE KEY UPDATE
      ACREEDOR_ID        = src.ACREEDOR_ID,
      PAIS_ID            = src.PAIS_ID,
      MONEDA_ID          = src.MONEDA_ID,
      NUMERO_FACTURA     = src.NUMERO_FACTURA,
      RAZON_SOCIAL       = src.RAZON_SOCIAL,
      NOMBRE_PAIS        = src.NOMBRE_PAIS,
      CODIGO_MONEDA      = src.CODIGO_MONEDA,
      FECHA_LIMITE_PAGO  = src.FECHA_LIMITE_PAGO,
      DIAS_VENCIMIENTO   = src.DIAS_VENCIMIENTO,
      RANGO_VENCIMIENTO  = src.RANGO_VENCIMIENTO,
      MONTO_RESTANTE     = src.MONTO_RESTANTE;
END$$
...
LEFT JOIN PA_DETALLES_FACTURA df ON df.FACTURA_ID = f.FACTURA_ID AND df.FECHA_ELIMINACION IS NULL;
