...
public class ReportePropPagoDAOImpl extends DAOImplBase implements ReportePropPagoDAO {
    ...
    private String generarSelectSinWhere(){
        return """
               SELECT 
...
//        this.statement.setInt(1, parametros.getIdPais());
        this.statement.setInt(1, parametros.getIdBanco());
        this.statement.setTimestamp(2, new Timestamp(parametros.getFechaInicio().getTime()));
        this.statement.setTimestamp(3, new Timestamp(parametros.getFechaFin().getTime()));
    }
