...
namespace SoftPacWA
{
    public partial class ReportePropuestas : System.Web.UI.Page
    {
        ...
        private void CargarDatosAuditoria()
        {
            ...
            lblUsuario.Text = $"{UsuarioLogueado.Nombre} {UsuarioLogueado.Apellidos} ({UsuarioLogueado.CorreoElectronico})";
        }
        ...
        private void CargarFiltros()
        {
            ...
            {
                // Cargar países
                var paises = UsuarioLogueado.UsuarioPais
                    .Where(up => up.Acceso)
                    .Select(up => up.Pais)
                    .ToList();
        ...
        private void GenerarReporte()
        {
            try
            {
                ...
                if (datos.Count > 0)
                {
                    ...
                    lblTotalMontos.Text = string.Join(" | ", montosAgrupados);
                }
                else
                {
