...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-title mb-4">
        <h3>
            <i class="fas fa-money-check-alt"></i>Reporte Detallado de Propuestas de Pago
        </h3>
    </div>
    ...
    <div class="reporte-container">
        ...
        <div class="reporte-header">
            <h2><i class="fas fa-file-invoice-dollar"></i>REPORTE DE PROPUESTAS DE PAGO</h2>
        ...
        <asp:UpdatePanel ID="upReporte" runat="server">
            <ContentTemplate>
                        ...
                        <div class="propuesta-card">
                            ...
                            <div class="propuesta-body">
                                ...
                                <h6 class="mb-3" style="color: var(--color-primary); font-weight: 600;">
                                    <i class="fas fa-list"></i>Detalle de Pagos Individuales
                                </h6>
                                ...
                                <div class="totales-moneda">
                                    <h6><i class="fas fa-coins"></i>Totales por Moneda</h6>
                ...
                <asp:Panel ID="pnlResumenGeneral" runat="server" CssClass="resumen-general" Visible="false">
                    <h4><i class="fas fa-chart-bar"></i>Resumen General del Reporte</h4>
