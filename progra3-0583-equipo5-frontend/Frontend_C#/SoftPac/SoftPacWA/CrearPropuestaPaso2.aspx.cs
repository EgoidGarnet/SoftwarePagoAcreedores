    ...
    public partial class CrearPropuestaPaso2 : System.Web.UI.Page
    {
        ...
        protected void btnContinuar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridViewRow row in gvFacturas.Rows)
                {
                    ...
                    if (chk != null && chk.Checked)
                    {
                        ...
                        if (facturas != null && row.RowIndex < facturas.Count)
                        {
                            ...
                            if (factura.FacturaId.HasValue)
                            {
                                facturasSeleccionadas.Add(factura.FacturaId.Value);
                            }
                        }
                    }
                }
                ...
                if (propuestaParcial.DetallesPropuesta == null || propuestaParcial.DetallesPropuesta.Count == 0)
                {
                ...
                {
                    if (propuestaParcial.DetallesPropuesta.All(d => d.Factura.FacturaId != fac))
                    {
